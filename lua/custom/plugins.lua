...
local plugins = {
  ...
  },
  {
    ...
    cmd = {
      ...
      "HaftValidate",
      "HaftVerify",
      "HaftAutoRestartEnable",
      "HaftAutoRestartDisable",
      "HaftAutoRestartToggle",
      "HaftInit",
      "HaftInitTui",
      "HaftInitWizard",
      "HaftInitQuick",
    ...
    keys = {
      ...
      { "<leader>hD", "<cmd>HaftDoctor<cr>", desc = "Haft doctor" },
      { "<leader>ha", "<cmd>HaftAdd<cr>", desc = "Haft add dependency" },
      { "<leader>hgr", "<cmd>HaftGenerateResource<cr>", desc = "Haft generate resource" },
      { "<leader>hb", "<cmd>HaftBuild<cr>", desc = "Haft build" },
      { "<leader>ht", "<cmd>HaftTest<cr>", desc = "Haft test" },
      { "<leader>hS", "<cmd>HaftServe<cr>", desc = "Haft serve" },
      { "<leader>hR", "<cmd>HaftRestart<cr>", desc = "Haft restart" },
      { "<leader>hn", "<cmd>HaftInit<cr>", desc = "Haft new project" },
      { "<leader>hv", "<cmd>HaftVersion<cr>", desc = "Haft version" },
    },
  },
}
return plugins
